      ...
      >
        ...
        <div className="flex items-center justify-between p-6 border-b border-slate-100 dark:border-slate-800">
          <div>
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400">Update your portfolio balance</p>
          </div>
          <button 
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="space-y-4">
            ...
            {/* Amount/Price Grid */}
            <div className={`grid ${type === 'deposit' ? 'grid-cols-1' : 'grid-cols-2'} gap-4`}>
              <div className="space-y-2">
          ...
          <div className="flex gap-3 pt-2">
            ...
            >
              {type === 'deposit' ? 'Add Funds' : type === 'buy' ? 'Confirm Buy' : 'Confirm Sell'}
            </button>
          </div>
        </form>
      </div>
